...
export default function Navbar() {
    return (
        <>
            <nav className={`${styles.navbar} bg-gray-800`}>
                ...
                <div className="sm:hidden" id="mobile-menu">
                    <div className="px-2 pt-2 pb-3 space-y-1">
                        ...
                        <a href="#thesis" className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Thesis</a>
